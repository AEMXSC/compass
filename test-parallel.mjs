...
const WINDOWS = [
  {
    ...
    prompts: [
      ...
      // TIER2 accessibility: suggest_alt_text — accessibility MCP ~40-55s
      { label: 'suggest alt text',    text: 'Suggest alt text for any images on this Lifepoint home page that are missing descriptions',                                    maxWait: 60 },
    ],
  },
  {
    id: 'B',
    ...
    prompts: [
      ...
      // TIER2 assets (3 tools): browse_dam_folder — runs while SPA is healthy (before content QA timeout risk)
      ...
      // TIER2 contentqa: run_content_qa — graceful skip if no entitlement, last in window
      { label: 'content QA check',    text: 'Run a content quality check on the Frescopa home page — check SEO, readability, and missing meta tags',                        maxWait: 50 },
    ],
  },
  {
    id: 'C',
    ...
    prompts: [
      ...
      // TIER1 search_dam_assets + TIER2 images transform_image — DM transform is near-instant vs Gemini 90s
      { label: 'LinkedIn banner',      text: 'Create a LinkedIn banner (1128×191) from the Frescopa coffee assets already in the DAM — use image transform tools to resize, do not generate a new image',  maxWait: 60, authNote: true },
  ...
  },
  {
    ...
    prompts: [
      ...
      { label: 'translate hero',       text: 'Translate the Frescopa home page hero headline and subtext to Spanish',                                                        maxWait: 65, authNote: true },
    ],
  },
];
